...
//        driver.close();
    ...
    public void test01() throws InterruptedException {
        ...
        WebElement kulAdiAcildiMi = driver.findElement(By.xpath("//*[text()=' Logged in as ']"));
        Assert.assertTrue(kulAdiAcildiMi.isDisplayed());
        ...
        WebElement sepetGorunurMu = driver.findElement(By.cssSelector("li[class='active']"));
        ...
        String actuallBillingAdress =driver.findElement(By.xpath("(//*[@class='col-xs-12 col-sm-6'])[2]//ul")).getText();
        String exceptedBillingAdress ="YOUR BILLING ADDRESS\n" +
                "Mrs. Kübra Durmuş\n" +
                "TechPro\n" +
                "Bursa\n" +
                "Nilüfer\n" +
                ...
                "Canada\n" +
                "05468";
        Assert.assertEquals(actuallBillingAdress, exceptedBillingAdress);
